    ...
    <div className="space-y-16 pb-20">
      <div>
        ...
        <p className="text-xl text-muted-foreground max-w-2xl">
          ...
          treatment. Uses data attributes for GSAP counter animations. Includes
          a subtle top glow and hover state.
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <StatCard
            countValue={30000}
            suffix="+"
            label="impressões em eventos"
          />
          <StatCard
            countValue={5}
            prefix="Top "
            suffix="°"
            label="melhor computação do Brasil"
          />
      ...
      <section className="space-y-6">
        ...
        <p className="text-muted-foreground text-sm">
          The <code className="bg-muted px-1 rounded">countValue</code> prop
          sets the <code className="bg-muted px-1 rounded">data-count</code>{" "}
          attribute for GSAP counter animations via{" "}
          <code className="bg-muted px-1 rounded">
            gsap.to(counter, {"{ val: target }"} )
          </code>
          .
        </p>
