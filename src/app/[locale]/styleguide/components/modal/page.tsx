          ...
          <Modal.Root isOpen={isOpen} onClose={() => setIsOpen(false)}>
            ...
            <Modal.Content>
              <Modal.Header>
                ...
                <p className="text-primary font-bold">Subtítulo ou Informação</p>
              </Modal.Header>
              
              <div className="space-y-4 mt-6">
                <p className="text-muted-foreground">
                  Este é um modal de exemplo. O conteúdo é renderizado usando os componentes 
                  <code> Modal.Root</code>, <code> Modal.Overlay</code>, <code> Modal.Content</code>, 
                  <code> Modal.Header</code> e <code> Modal.Close</code>.
                </p>
